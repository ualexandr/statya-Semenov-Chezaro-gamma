...
\footnote{Работа выполнена при поддержке гранта такого-то (вписать!!!)}
%TODO: данные о гранте
\\
{\it Н.Н. Авдеев } \\
...
Определим на пространстве ограниченных последовательностей $l_\infty$ оператор Чезаро $C$
%TODO: ссылка на JFA
равенством
$
...
характеризующую асимпототические свойства последовательности,
равенством
$$
...
\begin{equation}\label{ocenka_Semenov}
...
или, что то же самое, не существует такого $p\in \mathbb{N}$,
	что для любого $x\in A$ выполнено
	$
...
Обратим внимание на структурное сходство этой оценки и оценки (\ref{ocenka_Semenov}).


%%%%  ОФОРМЛЕНИЕ СПИСКА ЛИТЕРАТУРЫ %%%
\smallskip \centerline{\bf Литература}\nopagebreak

1. {\it Evgenii M. Semenov, Fedor A. Sukochev} Invariant Banach limits and applications.
 Journal of Functional Analysis 259 (2010) pp. 1517–1541.
