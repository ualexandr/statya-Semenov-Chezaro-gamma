...
\NewEnviron{hypothesis}{%
	...
	%\edef\curcaption{\paragraph{Гипотеза \protect\curref.}}

	%\expandafter\g@addto@macro\expandafter\hypotlist\expandafter
	%{\paragraph\noexpand\bgroup Гипотеза \ref\noexpand\bgroup}}
	%\g@addto@macro\expandafter\hypotlist%\expandafter
	%{\paragraph{Гипотеза \ref{\curlabel}}}
	%\expandafter\g@addto@macro\expandafter\hypotlist\expandafter
	%{\noexpand\egroup\noexpand\egroup}
