...
\end{equation*}
введенную в работе \cite{Avdeev2019}. Легко видеть, что последовательность $\{M(j)\}_{j=1}^\infty$ вогнута. Однако, в работе \cite{Fekete} (см. также \cite[I, Задача 98]{}) доказано, что в таком случае предел выражения $M(j)/j$ существует и справедливо равенство
